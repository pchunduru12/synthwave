// mobile/app/(auth)/login.tsx — drop-in replacement
...
export default function LoginScreen() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setError(humanize(err?.message) || 'Login failed.');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.scroll}>
      <View style={styles.card}>
        ...
        <View style={styles.form}>
          ...
          <Button label="Log in" onPress={submit} loading={submitting} fullWidth />
...
const styles = StyleSheet.create({
  ...
  logoBlock: {
    ...
    ...(Platform.OS === 'web'
      ? ({ backgroundImage: 'linear-gradient(135deg, #ff2d95 0%, #00e5ff 100%)' } as any)
      : null),
  },
